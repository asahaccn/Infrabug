...
docker build -t onewaydock .

# -------------------------------
# Docker Hub Login
# -------------------------------
# Ensure ~/my_password.txt contains your Docker Hub password or access token
cat ~/my_password.txt | docker login -u arpansaha359 --password-stdin

# -------------------------------
# Tag the image for Docker Hub
# -------------------------------
docker tag onewaydock:latest arpansaha359/onewaydock:latest

# -------------------------------
# Push the image to Docker Hub
# -------------------------------
docker push arpansaha359/onewaydock:latest
...
# -------------------------------
docker run -dp 80:80 --restart unless-stopped arpansaha359/onewaydock:latest
